# Generated by Django 5.2.4 on 2025-07-19 10:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "scope",
                    models.CharField(
                        choices=[("school", "School_level"), ("class", "Class_level")],
                        max_length=10,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phone",
                    models.CharField(
                        max_length=10, validators=[api.validators.validate_phone_number]
                    ),
                ),
                (
                    "roll_number",
                    models.CharField(
                        max_length=3, validators=[api.validators.validate_roll_number]
                    ),
                ),
                ...
                (
                    "date_of_birth",
                    models.DateField(
                        validators=[api.validators.validate_date_of_birth]
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=20,
                        unique=True,
                        validators=[api.validators.validate_employee_id],
                    ),
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("exam", "student"), name="one_submission_per_exam"
            ),
        ),
